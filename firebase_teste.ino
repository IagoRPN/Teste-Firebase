...
const int tam_list = 4; //quantidade de informações na lista

typedef struct  { //estrutura que armazena os dados
    int idade;
    String nome;
} data_list;

 data_list DL[tam_list]; //array de integração com firebase

void AtualizaLista() { //função de atualização da lista
